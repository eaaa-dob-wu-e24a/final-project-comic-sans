...
const CreateEvent = () => {
    ...
    return (
        <div className="flex flex-col px-4 pt-16 pb-8 space-y-4 bg-gradient-to-r from-gradientstart to-gradientend pb-0">
                ...
                <form onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input
                            ...
                            id="title"
                            name="title"
                            className="rounded-full mt-1 px-4 py-2 text-black bg-gray-300 rounded"
                            value={title}
                        ...
                        {proposedDates.map((date, index) => (
                            <div key={index} className="flex space-x-2 mt-2">
                                <input
                                    ...
                                    className="rounded-full flex-1 px-4 py-2 text-black bg-gray-300 rounded"
