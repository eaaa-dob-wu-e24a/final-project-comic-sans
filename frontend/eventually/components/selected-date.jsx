          ...
          <div className="flex items-center gap-2 md:gap-4 lg:gap-4 mb-1 md:mb-2 lg:mb-2 relative ml-auto md:ml-auto lg:ml-auto">
            <div className="flex flex-col items-start">
              ...
              <input
                ...
                type="time"
                className="rounded-full min-w-18 md:min-w-28 lg:min-w-28 border px-2 py-1 text-sm text-dark focus:outline-none focus:border-primary cursor-pointer"
            ...
            <div className="flex flex-col items-start">
              ...
              <select
                ...
                className="block min-w-18 md:min-w-20 lg:min-w-20 rounded-full border px-2 py-1.5 text-sm text-dark leading-5 focus:outline-none focus:border-primary"
            ...
            <button
              type="button"
              className={`flex-shrink-0 flex items-center justify-center text-white rounded-full w-6 h-6 ml-2 ${
                timeIndex === 0 ? "pt-2" : ""
              }`}
